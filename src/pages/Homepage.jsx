    ...
    return (
        <>
            <Container className="p-3" style={{ maxWidth: "70%" }}>
                ...
                <h1 className="mb-4" style={{ color: "#F9F9F9", fontSize: "44px", textAlign: "center" }}>Pricing</h1>
                <Row className="mb-3 justify-content-center">
                    <Col xs={12} md={6}>
                        <Card className="mb-3" style={{ boxShadow: "0 0 6px 3px rgba(255, 255, 255, 0.8)", backgroundColor: "rgba(0, 0, 0, 0.2)", backdropFilter: "blur(7px)", color: "#F9F9F9", width: "100%" }}>
                            <Card.Body>
                                <Card.Title>Weekdays</Card.Title>
                                <Card.Subtitle className="mb-2">(Monday - Thursday)</Card.Subtitle>
                                <Card.Text>
                                    Adults: RM50 /<i className="bi bi-person-standing"></i> <br />
                                    Students: RM40 /<i className="bi bi-person-standing"></i>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col xs={12} md={6}>
                        <Card className="mb-3" style={{ boxShadow: "0 0 6px 3px rgba(255, 255, 255, 0.8)", backgroundColor: "rgba(0, 0, 0, 0.2)", backdropFilter: "blur(7px)", color: "#F9F9F9", width: "100%" }}>
                            <Card.Body>
                                <Card.Title>Weekdends / Public Holidays</Card.Title>
                                <Card.Subtitle className="mb-2">(Friday - Sunday)</Card.Subtitle>
                                <Card.Text>
                                    Adults: RM60 /<i className="bi bi-person-standing"></i> <br />
                                    Students: RM50 /<i className="bi bi-person-standing"></i>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
